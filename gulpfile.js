...
gulp.task("css-app", function() {
  return gulp
    .src(["src/scss/font.scss", "src/scss/styles.scss"])
    .pipe(sass())
...
gulp.task("plugins", function() {
  ...
  download(["https://jvectormap.com/js/jquery-jvectormap-world-mill.js"]).pipe(
    gulp.dest("dist/assets/plugins/jvectormap-next/")
  );
  ...
  return gulp
    .src(pluginFiles, { base: "./node_modules/" })
...
gulp.task("watch", function() {
  ...
  gulp.watch("src/js/**/*.js", gulp.series(gulp.parallel(["js-pages"])));
